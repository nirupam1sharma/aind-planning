...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            # check whether all precondtions are satisfied
            if a_node.prenodes.issubset(self.s_levels[level]):
                a_nodes.add(a_node)
                # connect state and action nodes
    ...
    def __is_in_conflict__(self, preconds_or_effects1: list, preconds_or_effects2: list) -> bool:
        """
        Checks whether preconditions or effects are in conflicts with each other
        :param preconds_or_effects1: list
        :param preconds_or_effects2: list
        """
        preconds_or_effects1_set = set(preconds_or_effects1)
        preconds_or_effects2_set = set(preconds_or_effects2)

        return preconds_or_effects1_set & preconds_or_effects2_set
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return self.__is_in_conflict__(a1.effect_add, a2.effect_rem) or \
               self.__is_in_conflict__(a1.effect_rem, a2.effect_add)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return self.__is_in_conflict__(a1.effect_add, a2.precond_neg) or \
               self.__is_in_conflict__(a1.effect_rem, a2.precond_pos) or \
               self.__is_in_conflict__(a2.effect_add, a1.precond_neg) or \
               self.__is_in_conflict__(a2.effect_rem, a1.precond_pos)

    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        """
        Test a pair of actions for mutual exclusion, returning True if one of
        the parent of one action is mutex with a parent of the
        other action.
        ...
        return any(parent1.is_mutex(parent2) for parent1 in a1_parents for parent2 in a2_parents)
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        return all(parent1.is_mutex(parent2) for parent1 in s1_parents for parent2 in s2_parents)
        ...
        for level, s_level in enumerate(self.s_levels):
            ...
            for s_node in s_level:
                ...
                if s_node.symbol in self.problem.goal and \
                    ...
                    level_sum += level
                    goals_found_so_far.add(s_node.symbol)
